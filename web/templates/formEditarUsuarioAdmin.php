<div class="container p-4">
    ...
    <?php if (isset($_SESSION['usuario']) && ($_SESSION['usuario']['nivel_usuario'] === 'superadmin' || $_SESSION['usuario']['nivel_usuario'] === 'admin')): ?>
        ...
        <form action="index.php?ctl=editarUsuarioAdmin&idUser=<?= htmlspecialchars($params['usuario']['idUser'] ?? '') ?>" method="post">
            ...
            <a href="index.php?ctl=listarUsuariosAdmin" class="btn btn-secondary">Cancelar</a>
        </form>
