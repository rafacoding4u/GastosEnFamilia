<div class="container p-4">
    ...
    <div class="mb-4">
        <form method="GET" action="index.php">
            <input type="hidden" name="ctl" value="listarUsuariosAdmin">
            <div class="form-row">
                <div class="col">
            ...
            <tbody>
                <?php foreach ($params['usuarios'] as $usuario): ?>
                    <tr>
                        ...
                        <td><?= !empty($usuario['familias']) ? htmlspecialchars($usuario['familias']) : 'Sin Familia' ?></td>
                        <td><?= !empty($usuario['grupos']) ? htmlspecialchars($usuario['grupos']) : 'Sin Grupo' ?></td>
