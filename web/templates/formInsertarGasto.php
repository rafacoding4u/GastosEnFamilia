<div class="container p-4">
    ...
    <!-- Formulario para insertar gasto, enviando la solicitud al controlador adecuado -->
    <form action="index.php?ctl=FinanzasController&action=insertarGasto" method="post">
